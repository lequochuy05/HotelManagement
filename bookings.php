            ...
            while($data = mysqli_fetch_assoc($res))
            {
                ...
                if($data['booking_status'] == 'booked')
                {
                    ...
                    if($data['arrival'] == 1)
                    {
                        ...
                        {
                            $btn .= "<button type='button' onclick='reviewRoom($data[booking_id], $data[room_id])' data-bs-toggle='modal' data-bs-target='#reviewModal' class='btn btn-dark btn-sm shadow-none ms-2'>Rate & Review</button>
                            ";
                        }
                    }else
                    {
        ...
        <div class="modal-dialog">
            ...
            <form id="review-form">
                ...
                <div class="text-end">
                    ...
                    <!-- <button type="reset" class="btn btn- shadow-none">Cancel</button> -->
