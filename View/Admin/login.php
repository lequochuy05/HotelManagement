...
<html lang="en">
  ...
  <?php
    ...
    $redirectUri = 'http://localhost/HotelManagement/index.php?controller=admin&action=login';
...
<?php
  ...
  <?php
  require_once("View/Admin/message.php");
  if(isset($_POST['login'])){
    ...
    if(!$result->num_rows > 0){
      ...
      redirect('index.php?controller=admin&action=admin');
    }
  }
