<?php
    ...
    if(isset($_POST['get_bookings']))
    {
        ...
        $limit_res = select($limit_q, ["%$frm_data[search]%", "%$frm_data[search]%", "%$frm_data[search]%"], "sss");
        ...
        while($data = mysqli_fetch_assoc($limit_res)){
            ...
            $table_data .="
                <tr>
                    ...
                    <td>
                        <button type='button' onclick='download($data[booking_id])' class='btn btn-outline-success fw-bold shadow-none'>
